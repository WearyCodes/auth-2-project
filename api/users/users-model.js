...
function findBy(filter) {
   ...
   */
  return db("users")
    .join("roles", "users.role_id", "roles.role_id") // Join users and roles tables
    .select("user_id", "username", "password", "role_name") // Select required fields
    .where(filter)
    .first();
}
...
function findById(user_id) {
  ...
  return db("users")
    .join("roles", "users.role_id", "roles.role_id") // Join users and roles tables
    .select("user_id", "username", "role_name") // Select required fields
